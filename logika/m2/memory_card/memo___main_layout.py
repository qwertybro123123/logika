...
from PyQt5.QtWidgets import QApplication, QWidget,QTableWidget, QListWidget, QListWidgetItem ,QLineEdit, QFormLayout, QHBoxLayout,QListView, QVBoxLayout, QGroupBox, QButtonGroup, QRadioButton,QPushButton, QLabel, QSpinBox
